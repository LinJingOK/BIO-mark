...
features_list = []
with open(r'E:\workspace\PycharmProjects\BIO_mark_data\BIO_mark\data\word_dict.txt','r',encoding='gbk') as f:
...
with open(r'E:\workspace\PycharmProjects\BIO_mark_data\BIO_mark\data\word_dict.txt','r',encoding='gbk') as f:
     for line in f.readlines():
          ...
          if len(item) >1:
              ...
              with open(r'E:\workspace\PycharmProjects\BIO_mark_data\BIO_mark\result\error.txt','a',encoding='utf-8') as f:
                  f.write(line+"\n")
...
'''
file_input = r'E:\workspace\PycharmProjects\BIO_mark_data\subway_data_process\divide_data\dev.txt'
file_output = r'E:\workspace\PycharmProjects\BIO_mark_data\subway_BIO_mark\result\dev_remarked.txt'
index_log = 0
