...
'''
file_input = r'E:\workspace\PycharmProjects\BIO_mark_data\BIO_mark\data\text_unlabel.txt'
file_output = r'E:\workspace\PycharmProjects\BIO_mark_data\BIO_mark\result\text_label.txt'
index_log = 0
